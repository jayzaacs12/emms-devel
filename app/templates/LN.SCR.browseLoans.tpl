...
{searchForm_scr_name_html}
  <tr>
    <td class=label>{searchForm_loan_code_label}</td>
    <td>{searchForm_loan_code_html}</td>
  </tr>
  <tr>
    <td class=label>{searchForm_first_label}</td>
    <td>{searchForm_first_html}</td>
  </tr>
  <tr>
    <td class=label>{searchForm_last_label}</td>
    <td>{searchForm_last_html}</td>
  </tr>
  <tr>
    <td class=label>{searchForm_status_label}</td>
    <td>{searchForm_status_html}</td>
  </tr>
  <tr>
